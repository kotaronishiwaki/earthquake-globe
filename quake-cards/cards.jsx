...
(function () {
  ...
  const PAGERLVL = {
    green:  { color: '#5b9e6f', bg: 'rgba(91,158,111,0.12)',
      ...
      impact: { en: 'Widespread casualties or major damage are unlikely, but strong local shaking can still hurt vulnerable buildings.', ja: '広い範囲での死傷や大きな被害は起きにくいとされますが、震源付近の強い揺れで脆弱な建物は損傷しえます。', zh: '大范围人员伤亡或重大破坏的可能性较低，但震中附近的强烈晃动仍可能损坏脆弱建筑。', hi: 'व्यापक हताहत या बड़ी क्षति की संभावना कम है, पर नजदीकी तेज़ झटकों से कमज़ोर इमारतें क्षतिग्रस्त हो सकती हैं।', es: 'Es poco probable que haya víctimas o daños mayores generalizados, pero la fuerte sacudida local aún puede dañar edificios vulnerables.', ar: 'من غير المرجح وقوع إصابات أو أضرار كبيرة واسعة، لكن الاهتزاز القوي المحلي قد يضرّ المباني الهشة.' } },
