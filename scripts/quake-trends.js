...
// USGS sits behind a WAF that often 404s requests from datacenter IPs (like
// GitHub Actions) that don't look like a browser, so send browser-like headers.
const HEADERS = {
  'Accept': 'application/json,*/*',
  'User-Agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) ' +
                'Chrome/124.0 Safari/537.36 earthquake-globe/1.0 (+https://globelabo.netlify.app)',
};

// USGS fdsnws can also return transient 404/429/5xx under load, so fetch one
// window at a time, with retries and backoff.
